...
export PATROL_INTERVAL_SECONDS="${PATROL_INTERVAL_SECONDS_OVERRIDE:-60}"
echo "starting patrol_gateway with PATROL_INTERVAL_SECONDS=${PATROL_INTERVAL_SECONDS}"

ros2 run smart_care_bridge patrol_gateway
